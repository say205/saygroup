(function($) {
	...
	$(document).ready(function() {
		...
		$('.account-tab-controls li').on('click', function (){
			var tab_id = $(this).attr('data-tab');
			$('.account-tab-controls li').removeClass('active');
			$('.account-tab-content .account-tab-item').removeClass('active');
			$(this).addClass('active');
			$("#"+tab_id).addClass('active');
		});
		...
		/*  [ Notifications ]
        - - - - - - - - - - - - - - - - - - - - */
		$('.icon-bell i').on('click', function (){
			$(this).parent().parent().find('.notifications-list').fadeIn(0);
		});
